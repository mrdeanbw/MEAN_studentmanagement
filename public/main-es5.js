...
var AddStudentComponent = /** @class */ (function () {
    ...
    /* Submit book */
    AddStudentComponent.prototype.submitStudentForm = function () {
        var _this = this;
        if (this.studentForm.valid) {
            this.studentApi.AddStudent(this.studentForm.value).subscribe(function (res) {
                _this.ngZone.run(function () { return _this.router.navigateByUrl('/students-list'); });
            });
        }
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var EditStudentComponent = /** @class */ (function () {
    function EditStudentComponent(fb, router, ngZone, actRoute, studentApi) {
        ...
        this.studentApi.GetStudent(id).subscribe(function (data) {
    ...
    EditStudentComponent.prototype.updateStudentForm = function () {
        ...
        if (window.confirm('Are you sure you want to update?')) {
            this.studentApi.UpdateStudent(id, this.studentForm.value).subscribe(function (res) {
                _this.ngZone.run(function () { return _this.router.navigateByUrl('/students-list'); });
            });
        }
    };
...
var StudentsListComponent = /** @class */ (function () {
    ...
    StudentsListComponent.prototype.deleteStudent = function (index, e) {
...
var ApiService = /** @class */ (function () {
    ...
    // Add student
    ApiService.prototype.AddStudent = function (data) {
    ...
    ApiService.prototype.GetStudent = function (id) {
        var API_URL = this.endpoint + "/read-student/" + id;
    ...
    ApiService.prototype.UpdateStudent = function (id, data) {
        var API_URL = this.endpoint + "/update-student/" + id;
